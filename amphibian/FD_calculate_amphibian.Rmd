...
parental_care_in_frogs <- read.csv(
                'Vagi_et_al_Climate_and_mating_systems_as_drivers_of_global_diversity_of_parental_care_in_frogs/Vagi_et_al_S3_Amphibian_Supplementary_data.csv') %>% 
...
p1 <- fviz_mfa_var(mfa, "group", labelsize=3, xlim = c(-0.1,0.95)) # the correlation between groups and dimensions. red color = active groups of variables; green color = supplementary groups of variables
