...
# find ./ -name "*" -type f -size 0c |sed 's/\.\//python 12S_RNA_add.py /g' |sed 's/\.fasta//g' >> ../FailedCommands

cd ..
# sort commands_12S_RNA_add.txt FailedCommands FailedCommands | uniq -u > commands_12S_RNA_add.txt.completed
