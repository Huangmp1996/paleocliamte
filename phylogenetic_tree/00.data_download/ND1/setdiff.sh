...
# find ./ -name "*" -type f -size 0c |sed 's/\.\//python ND1_add.py /g' |sed 's/\.fasta//g' >> ../FailedCommands

cd ..
# sort commands_ND1_add.txt FailedCommands FailedCommands | uniq -u > commands_ND1_add.txt.completed
